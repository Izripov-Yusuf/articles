...
Наконец, давайте поговорим о новейших возможностях, которые принесли нам React 18 и грядущий React 19. Они направлены на улучшение работы с асинхронностью, данными и рендерингом на стороне сервера. В первую очередь это React Suspense и Server Components. Эти вещи ещё не до конца устоялись в среде разработчиков, но их стоит держать в уме.
